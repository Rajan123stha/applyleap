...
export const Banner = ({ label, image }) => {
    ...
    >
      ...
      <div className="w-full min-h-[50vh] md:min-h-[50vh] lg:min-h-[85vh] py-12 px-6 md:px-12 lg:px-24">
        ...
        <div className="relative mt-6 text-left max-w-6xl mx-auto space-y-6 text-white lg:space-y-8">
          <h1 className="text-lg md:text-3xl lg:text-4xl font-bold ">Test</h1>
          <p className="text-sm md:text-base  text-left md:w-3/5 lg:w-2/5">
            Get all the information you need to pursue your dreams
            abroad—independently and confidently.
          </p>
